    ...
    return (
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={attendance} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="pinEmploye" header="Pin" sortable style={{ minWidth: '12rem',backgroundColor: colors.primary[400], fontWeight: "500" }} ></Column>
                    <Column field="state" header="Estado" sortable style={{ minWidth: '12rem',backgroundColor: colors.primary[400], fontWeight: "500"}}></Column>
                    <Column field="time" header="Hora/Fecha" sortable style={{ minWidth: '12rem',backgroundColor: colors.primary[400], fontWeight: "500", }}></Column>
